      ...
      <div className="max-w-4xl bg-white shadow-xl rounded-2xl p-10 md:p-14">
        ...
        <header className="text-center md:text-left border-b pb-6">
          ...
          <div className="text-sm text-gray-500 mt-3 space-y-1">
            <p>
              ...
              +8801616176409 <br /> <MdEmail className="inline-block mr-1" />{" "}
            ...
            <div className="flex gap-4 justify-center md:justify-start mt-2">
              <div className="flex items-center justify-center">
                ...
                <a
                  href="https://anik-bin-sayed.netlify.app/"
              ...
              <div className="flex items-center justify-center">
                ...
                <a
                  href="https://www.linkedin.com/in/anik-ibne-sayed-b61498365/"
                  className="text-cyan-600 hover:underline"
                >
                  LinkedIn
                </a>
        ...
        <section className="mt-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            I am a passionate and self-taught programmer from a non-CS
            background, looking to work in a challenging software development
            role where I can apply my knowledge of programming, problem-solving,
        ...
        <section className="mt-8">
          ...
          <ul className="space-y-2 text-gray-700">
            ...
            <li>
              <b>Concepts:</b> REST APIs, CRUD, Authentication, MVC Pattern, MVT
        ...
        <section className="mt-8">
          ...
          <ul className="text-gray-700 space-y-1">
            <li>
              <b>BBA Honours Department of Bangla</b> <br /> Government Titumir
              College, Dhaka, Bangladesh (2023 – Present)
            </li>
            <span className="italic text-sm">
              Additional Training: Completed Full Stack Web Development Bootcamp
              from Ostad (Online platform), March–June 2025
            </span>
            <li className="flex items-center gap-2">
              CGPA : <p className="text-red-900"> Not completed yet</p>
            </li>
          </ul>
        </section>
        ...
        <section className="mt-8">
          ...
          <div className="text-gray-700 space-y-1">
            <p>
              <b>Full Stack Web Development Training </b> <br /> Ostad |
              Duration: March 2025 – January 2026
              <ul className="list-disc ml-6 mt-1">
                <li>Completed hands-on training on Python, Django, React</li>
                <li>
                  Built several real-world projects, including responsive
                  websites and RESTful APIs
                </li>
                <li>
                  Learned Git & GitHub, deployment, debugging, and version
                  control best practices
                </li>
                <li>
                  Followed industry-standard coding practices and collaborated
                  in group projects
                </li>
              </ul>
            </p>
